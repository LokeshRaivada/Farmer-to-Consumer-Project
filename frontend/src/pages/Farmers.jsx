    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '2rem auto', padding: '0 1rem', textAlign: 'left' }}>
            ...
            {loading ? (
                ...
                <div className="glass" style={{ textAlign: 'center', padding: '4rem 2rem', borderRadius: '1.25rem', border: '1px solid var(--glass-border)', maxWidth: '500px', margin: '2rem auto' }}>
                    <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>⚠️</div>
                    <h3 style={{ fontSize: '1.2rem', fontWeight: 'bold', color: 'var(--text-light)', marginBottom: '0.5rem' }}>Connection Error</h3>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>{error}</p>
                    <button onClick={fetchFarmers} className="btn btn-primary" style={{ padding: '0.5rem 1.5rem', borderRadius: '2rem' }}>Retry</button>
                </div>
            ) : (
